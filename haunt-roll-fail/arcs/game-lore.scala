...
case object ToolPriests       extends Lore("lore01", "Sacerdotes de las herramientas")
case object GalacticRifles    extends Lore("lore02", "Rifles galácticos")
case object SprinterDrives    extends Lore("lore03", "Motores veloces")
case object MirrorPlating     extends Lore("lore04", "Blindaje de espejo")
case object HiddenHarbors     extends Lore("lore05", "Puertos ocultos")
case object SignalBreaker     extends Lore("lore06", "Inhibidor de señal")
case object RepairDrones      extends Lore("lore07", "Drones de reparación")
case object GatePorts         extends Lore("lore08", "Puertos de puerta")
case object CloudCities       extends Lore("lore09", "Ciudades nube")
case object LivingStructures  extends Lore("lore10", "Estructuras vivas")
case object GateStations      extends Lore("lore11", "Estaciones de puerta")
case object RailgunArrays     extends Lore("lore12", "Baterías de cañón de riel")
case object AncientHoldings   extends Lore("lore13", "Posesiones antiguas")
case object SeekerTorpedoes   extends Lore("lore14", "Torpedos buscadores")
case object PredictiveSensors extends Lore("lore15", "Sensores predictivos")
case object ForceBeams        extends Lore("lore16", "Haces de fuerza")
case object RaiderExosuits    extends Lore("lore17", "Exoesqueletos asaltantes")
case object SurvivalOverrides extends Lore("lore18", "Prioridades de supervivencia")
case object EmpathsVision     extends Lore("lore19", "Visión de la empática")
case object EmpathsBond       extends Lore("lore20", "Vínculo de la empática")
case object KeepersTrust      extends Lore("lore21", "Confianza de los guardianes")
case object KeepersSolidarity extends Lore("lore22", "Solidaridad de los guardianes")
case object WarlordsCruelty   extends Lore("lore23", "Crueldad del señor de la guerra")
case object WarlordsTerror    extends Lore("lore24", "Terror del señor de la guerra")
case object TyrantsEgo        extends Lore("lore25", "Ego del tirano")
case object TyrantsAuthority  extends Lore("lore26", "Autoridad del tirano")
case object TycoonsAmbition   extends Lore("lore27", "Ambición del magnate")
case object TycoonsCharm      extends Lore("lore28", "Encanto del magnate")
case object GuildLoyaltyLL      extends Lore("lore29", "Lealtad del gremio") with UnofficialLore
case object CatapultOverdriveLL extends Lore("lore30", "Sobrecarga de catapulta") with UnofficialLore
